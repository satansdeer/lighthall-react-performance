...
import { LoadContentWithDelay } from "./src/LoadContentWithDelay";
...
<AnimationWithLag interval={5} />

<AnimationWithLag interval={80} slow />
...
<LoadContentWithDelay delay={2000}/>

<LoadContentWithDelay delay={6000} slow/>
...
<Step title="React DevTools" subtitle="Let's see what re-renders">
...
```jsx file=./src/ConsoleTime.example.js
```
...
```jsx file=./src/PerformanceNow.example.js
```
...
<Step title="Avoid re-renders" subtitle="Let's see if it helped">
